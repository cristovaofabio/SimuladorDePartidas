...
import com.dio.simuladordepartidas.R;
import com.dio.simuladordepartidas.data.MatchesApi;
import com.dio.simuladordepartidas.databinding.ActivityMainBinding;
import com.dio.simuladordepartidas.domain.Match;
import com.dio.simuladordepartidas.ui.adapter.MatchesAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void setupHttpClient() {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://cristovaofabio.github.io/matches-simulator-api/")
            ...
            view.animate().rotationBy(360).setDuration(500).setListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animation) {
                    ...
                    for (int i = 0; i < matchesAdapter.getItemCount(); i++) {
                       ...
                       match.getHomeTime().setScore(random.nextInt(match.getHomeTime().getStars()+1));
